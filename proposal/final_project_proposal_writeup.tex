...
\begin{itemize}
\item Language-specific subword models such as Japanese BERT (tohoku-nlp/bert-base-japanese-v3) are strong native-script baselines widely fine-tuned for Japanese tasks.
\item 
\end{itemize}
