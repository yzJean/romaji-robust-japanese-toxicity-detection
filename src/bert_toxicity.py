...
def load_data(csv_path: str, use_romaji: bool = False, test_size: float = 0.2) -> Tuple[List, List, List, List]:
    """
...
def main():
    ...
    print(classification_report(true_labels, predictions, target_names=['Non-Toxic', 'Toxic'], zero_division=0))
